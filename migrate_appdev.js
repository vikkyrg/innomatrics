...
const servicesDir = path.join('C:', 'Users', 'rvikk', 'Desktop', 'innomatrics', 'src', 'components', 'Services', 'Inno Services');

function rewriteAppDev() {
  const file = path.join(servicesDir, 'Appdev.jsx');
  let newContent = `import React, { forwardRef } from "react";
...
import {
  ...
  FaLayerGroup,
  FaCheckCircle,
  FaReact, FaShoppingCart, FaTruck, FaCar, FaHeart, FaGraduationCap, FaStethoscope, FaPlane, FaBriefcase, FaConciergeBell
} from "react-icons/fa";
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {platforms.map((platform, index) => (
              <div key={index} className="bg-surface-container-lowest border border-outline-variant/60 rounded-2xl p-8 hover:shadow-lg transition-all duration-300">
