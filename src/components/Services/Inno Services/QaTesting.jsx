...
const QaTesting = forwardRef((props, ref) => {
  ...
  const technologies = [
    { name: "Selenium", icon: <FaCogs className="text-blue-600 text-2xl" /> },
    { name: "Cypress", icon: <FaDesktop className="text-blue-600 text-2xl" /> },
    { name: "JUnit", icon: <FaCode className="text-blue-600 text-2xl" /> },
    { name: "Jest", icon: <FaCode className="text-blue-600 text-2xl" /> },
    { name: "Appium", icon: <FaMobile className="text-blue-600 text-2xl" /> },
    { name: "Postman", icon: <FaDatabase className="text-blue-600 text-2xl" /> },
    { name: "Jira", icon: <FaBriefcase className="text-blue-600 text-2xl" /> },
    { name: "Jenkins", icon: <FaCloud className="text-blue-600 text-2xl" /> },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mt-16">
            ...
            <p className="text-xl text-white max-w-1xl mt-2 text-left">
              Ensure your software is reliable, scalable, and bug-free with our rigorous testing processes.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img
                ...
                alt={hoveredService ? `${hoveredService} Services` : "Software Testing & QA Services"}
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-gradient-to-br from-blue-900 to-blue-800 rounded-lg p-8 text-white relative overflow-hidden group hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="relative z-10">
                    <h4 className="text-xl font-semibold mb-4">Bug Reduction</h4>
                    <p className="text-blue-100 mb-4">
                      Caught 99% of critical bugs before production via automated pipelines.
                    </p>
                    <div className="flex items-center gap-2 text-blue-200">
                      <span className="text-3xl font-bold">99%</span>
                      <span className="text-sm">Bugs Caught</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-blue-900 to-blue-800 rounded-lg p-8 text-white relative overflow-hidden group hover:shadow-xl transition-all duration-300">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-blue-700/20 rounded-full -mr-16 -mt-16"></div>
                  <div className="relative z-10">
                    <h4 className="text-xl font-semibold mb-4">Release Velocity</h4>
                    <p className="text-blue-100 mb-4">
                      Sped up deployment cycles by 3x using CI/CD test automation.
                    </p>
                    <div className="flex items-center gap-2 text-blue-200">
                      <span className="text-3xl font-bold">3x</span>
                      <span className="text-sm">Faster Releases</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-blue-900 to-blue-800 rounded-lg p-8 text-white relative overflow-hidden group hover:shadow-xl transition-all duration-300">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-blue-700/20 rounded-full -mr-16 -mt-16"></div>
                  <div className="relative z-10">
                    <h4 className="text-xl font-semibold mb-4">Test Coverage</h4>
                    <p className="text-blue-100 mb-4">
                      Achieved 95%+ code coverage on complex enterprise applications.
                    </p>
                    <div className="flex items-center gap-2 text-blue-200">
                ...
                <div className="bg-gradient-to-br from-blue-900 to-blue-800 rounded-lg p-8 text-white relative overflow-hidden group hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-blue-100 mb-4">
                      Identified and fixed memory leaks, boosting app speed by 40%.
                    </p>
                    <div className="flex items-center gap-2 text-blue-200">
              ...
              <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-8">
                <div className="text-center">
                  ...
                  <div className="text-gray-600 mt-2">Test Cases Written</div>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold text-blue-600">0</div>
                  <div className="text-gray-600 mt-2">Critical Escapes</div>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-600 mt-2">QA Automation Engineers</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-gray-800">
                  Innomatrics Tech ensures flawless software quality through rigorous automated and manual testing.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-800">
                  Executing comprehensive cross-browser and cross-device testing to guarantee universal compatibility.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-800">
                  Utilizing advanced testing frameworks like Selenium, Cypress, and Appium for end-to-end reliability.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 mb-16">
            ...
            <div className="w-full md:w-1/2 text-left">
              ...
              <p className="text-xl  text-gray-600">
                Our comprehensive Quality Assurance and software testing services ensure your applications perform flawlessly under any condition. We combine automated testing frameworks with meticulous manual review to guarantee a bug-free launch.
              </p>
            </div>
          ...
          <div className="mb-20">
            <h2 className="text-3xl font-bold text-center text-red-600 mb-12">
              Our Comprehensive Software Testing & QA Services
            </h2>
          ...
          <div className="mb-20 bg-blue-900 rounded-2xl p-12 text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <div className="text-xl">Test Cases Written</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold mb-2">0</div>
                <div className="text-xl">Critical Escapes</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold mb-2">100%</div>
                <div className="text-xl">Pipeline Automation</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold mb-2">20+</div>
                <div className="text-xl">QA Automation Engineers</div>
              </div>
            </div>
          </div>
