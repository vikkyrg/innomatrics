            ...
            <div className="relative">
              ...
              {showIndustries && (
                <div className="p-2 space-y-1 bg-gray-50 rounded-xl mt-2 ml-4 border border-gray-100 shadow-inner max-h-60 overflow-y-auto">
                  ...
                  <Link to="/healthcare" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaHeartbeat className="mr-3 inline-block text-primary-500 w-4 h-4" />Healthcare</Link>
                  <Link to="/banking-finance" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaUniversity className="mr-3 inline-block text-primary-500 w-4 h-4" />Banking & Finance</Link>
                  <Link to="/tours-travel" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaPlane className="mr-3 inline-block text-primary-500 w-4 h-4" />Tours & Travel</Link>
                  <Link to="/education" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaGraduationCap className="mr-3 inline-block text-primary-500 w-4 h-4" />Education</Link>
                  <Link to="/logistics" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaTruck className="mr-3 inline-block text-primary-500 w-4 h-4" />Logistics</Link>
                  <Link to="/restaurants" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaUtensils className="mr-3 inline-block text-primary-500 w-4 h-4" />Restaurants</Link>
                  <Link to="/ngo" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaHandsHelping className="mr-3 inline-block text-primary-500 w-4 h-4" />NGO</Link>
                  <Link to="/construction" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaHardHat className="mr-3 inline-block text-primary-500 w-4 h-4" />Construction</Link>
                  <Link to="/security" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaShieldAlt className="mr-3 inline-block text-primary-500 w-4 h-4" />Security</Link>
                  <Link to="/manufacturing" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaIndustry className="mr-3 inline-block text-primary-500 w-4 h-4" />Manufacturing</Link>
                  <Link to="/ecommerce" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaShoppingCart className="mr-3 inline-block text-primary-500 w-4 h-4" />E-Commerce</Link>
                  <Link to="/retail" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaStore className="mr-3 inline-block text-primary-500 w-4 h-4" />Retail</Link>
                  <Link to="/real-estate" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaBuilding className="mr-3 inline-block text-primary-500 w-4 h-4" />Real Estate</Link>
                  <Link to="/professional-services" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaUserTie className="mr-3 inline-block text-primary-500 w-4 h-4" />Professional Services</Link>
                  <Link to="/startups" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaRocket className="mr-3 inline-block text-primary-500 w-4 h-4" />Startups</Link>
                  <Link to="/garments" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaTshirt className="mr-3 inline-block text-primary-500 w-4 h-4" />Garments</Link>
                </div>
              )}
            </div>
            ...
            <div className="relative">
              ...
              {showHireDevelopers && (
                <div className="p-2 space-y-1 bg-gray-50 rounded-xl mt-2 ml-4 border border-gray-100 shadow-inner max-h-60 overflow-y-auto">
                  ...
                  <Link to="/react-developers" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaReact className="mr-3 inline-block text-primary-500 w-4 h-4" />React Developers</Link>
                  <Link to="/mobile-app-developers" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaMobileAlt className="mr-3 inline-block text-primary-500 w-4 h-4" />Mobile App Developers</Link>
                  <Link to="/ai-engineers" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaRobot className="mr-3 inline-block text-primary-500 w-4 h-4" />AI Engineers</Link>
                  <Link to="/digital-marketers" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaChartLine className="mr-3 inline-block text-primary-500 w-4 h-4" />Digital Marketers</Link>
                  <Link to="/nodejs-developers" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaNodeJs className="mr-3 inline-block text-primary-500 w-4 h-4" />Node.js Developers</Link>
                  <Link to="/full-stack-developers" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaLaptopCode className="mr-3 inline-block text-primary-500 w-4 h-4" />Full Stack Developers</Link>
                  <Link to="/ui-ux-designers" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaPalette className="mr-3 inline-block text-primary-500 w-4 h-4" />UI/UX Designers</Link>
                  <Link to="/development-team" className="flex items-center px-4 py-3 text-sm text-secondary-700 hover:text-primary-700 hover:bg-white rounded-lg font-medium transition-all" onClick={closeMenu}><FaUsers className="mr-3 inline-block text-primary-500 w-4 h-4" />Dedicated Team</Link>
                </div>
              )}
            </div>
